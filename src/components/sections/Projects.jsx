                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all">
                        ...
                        <div className="flex justify-between items-center">
                            <a href="https://github.com/fraireisaac1/lyst-v2" target="_blank" className="text-cyan-400 hover:text-cyan-300 transition-colors my-4">View Project &rarr;</a>
                        </div>
                    </div>
                    ...
                    <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all">
                        ...
                        <div className="flex justify-between items-center">
                            <a href="https://github.com/fraireisaac1/Deelish" target="_blank" className="text-cyan-400 hover:text-cyan-300 transition-colors my-4">View Project &rarr;</a>
                        </div>
                    </div>
                    ...
                    <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all">
                        ...
                        <div className="flex justify-between items-center">
                            <a href="https://github.com/fraireisaac1/wbla-3pm-es" target="_blank" className="text-cyan-400 hover:text-cyan-300 transition-colors my-4">View Project &rarr;</a>
                        </div>
                    </div>
                    ...
                    <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all">
                        ...
                        <div className="flex justify-between items-center">
                            <a href="https://github.com/fraireisaac1/mongodb-with-rest_client" target="_blank" className="text-cyan-400 hover:text-cyan-300 transition-colors my-4">View Project &rarr;</a>
                        </div>
                    </div>
                    ...
                    <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all">
                        ...
                        <div className="flex justify-between items-center">
                            <a href="https://github.com/fraireisaac1/mongoose-express-server" target="_blank" className="text-cyan-400 hover:text-cyan-300 transition-colors my-4">View Project &rarr;</a>
                        </div>
                    </div>
                    ...
                    <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all">
                        ...
                        <div className="flex flex-wrap gap-2 mb-4">
                            {["React", "MongoDB", "Canva"].map((tech, key) => (
                                <span key={key} className="bg-cyan-500/10 text-cyan-500 py-1 px-3 rounded-full text-sm hover:bg-cyan-500/20 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">{tech}</span>
                            ))}
                        </div>

                        <div className="flex justify-between items-center">
                            <a href="https://github.com/fraireisaac1/3pm-MECAZON-client-production" target="_blank" className="text-cyan-400 hover:text-cyan-300 transition-colors my-4">View Project &rarr;</a>
                        </div>
                    </div>
