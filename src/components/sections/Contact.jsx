        ...
        <RevealOnScroll>
            <div className="px-4 w-150">
                ...
                <form action="" className="space-y-6">
                    ...
                    <button type="submit" className="w-full bg-cyan-500 text-white py-3 px-6 rounded font-medium transition relative overflow-hidden hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59,130,246,0.4)]">
                        Send Message
                    </button>
                </form>
            </div>
